	...
	public void startProgram() {
		...
		while(true) {
			...
			case 2 :
				...
				// printStudentById() 메소드가 학생 정보를 조회, dao의 메소드를 selectOneById()로 명명
			...
			case 3 : 
				...
				// printStudentByName, printStudentsByName 둘 중에 어떤 것 사용?
				// selectOneByName, selectAllByName 둘 중에 어떤 것 사용?
				// showStudent, showAllStudents 둘 중에 어떤 것 사용?
				break;
			case 4 : 
			...
			case 5 : 
				// UPDATE STUDENT_TBL 
				// SET STUDENT_PW = 'pass11', EMAIL = 'khuser01@naver.com', PHONE = '01092094595', ADDRESS = '서울시 강남구', HOBBY = '코딩, 게임'
